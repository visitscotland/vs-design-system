...
<#include "../../frontend/stores/itineraries-store.ftl">
...
<#include "../../frontend/components/image-location-map.ftl">
<#include "../../frontend/components/button.ftl">
<#include "../../frontend/components/heading.ftl">
<#include "../../frontend/components/img.ftl">
<#include "../../frontend/components/tooltip.ftl">
<#include "../../frontend/components/summary-box-list.ftl">
<#include "../../frontend/components/summary-box-list-item.ftl">
<#include "../../frontend/components/summary-box-display.ftl">
<#include "../../frontend/components/summary-box-label.ftl">
<#include "../../frontend/components/summary-box-distance-display.ftl">
<#include "../../frontend/components/summary-box-distance-label.ftl">
<#include "../../frontend/components/summary-box-icon-with-label.ftl">
...
<#include "../../frontend/components/itinerary-day.ftl">
<#include "../../frontend/components/itinerary.ftl">
