...
<docs>
  ```jsx
  <div>
    <vs-textarea label="Default textarea" placeholder="Write your text" id="textarea-1" />
    <vs-textarea label=":focus" state="focus" placeholder="Write your text" id="textarea-2" />
    <vs-textarea label="[disabled]" disabled value="Write your text" id="textarea-3" />
  </div>
  ```
</docs>
