<template>
  <figure class="d-flex flex-column">
    <div role="img" class="vs-hero__image-wrapper">
      <slot name="image" /> <slot name="overlayText" />
      ...
      >
        ...
        <span role="button" class="sr-only">{{ this.toggleButtonText }}</span>
      </vs-button>
    </div>
    ...
    >
      <figcaption ref="figcaption">
        <vs-row>
          <vs-col>
            <div role="contentinfo" class="p-4" v-if="this.showCaptionData">
          ...
          <vs-col cols="auto" class="pl-0" v-if="showMap">
            <div role="navigation" class="map__wrapper">
...
<docs>
  ```jsx
    ...
    <img
      ...
      <span aria-role="contentInfo" slot="overlayText" class="vs-hero__overlay-text text-light">Scotland</span>
    </vs-hero>
  ```
</docs>
