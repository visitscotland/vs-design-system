...
describe("VsSvg", () => {
  ...
  describe("computed: attributes", () => {
    ...
    it("should add the extra attributes to the native attributes", () => {
      ...
      expect(wrapper.vm.attributes).toEqual(extend({}, mockNativeAttrs, extraAttrs))
    })
  })

  describe("computed: children", () => {
    it("should return the svg children", () => {
      let childrenTrimmed = trim(wrapper.vm.children.replace(/\n( )*/g, " "))
      expect(childrenTrimmed).toBe(mockSvgContent)
    })
  })
})
