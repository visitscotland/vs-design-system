...
describe("VsSvg", () => {
  ...
  describe("computed: attributes", () => {
    it("should return the calculated attributes", () => {
      expect(wrapper.vm.attributes).toEqual(mockNativeAttrs)
    })

    it("should add the height, width and fill to the calculated attributes", () => {
      expect(wrapper.vm.attributes).toEqual(extend({}, mockNativeAttrs, extraAttributes))
    })
  })

  describe("computed: children", () => {
    it("should return the svg children", () => {
      expect(wrapper.vm.children).toBe(`
        <path
          id="path4"
