...
const setupDevServer = (app, onServerBundleReady) => {
    ...
    const clientConfig = require(path.resolve(__dirname, '../../build/webpack.ssr.client.config'));
    const serverConfig = require(path.resolve(__dirname, '../../build/webpack.ssr.server.config'));
