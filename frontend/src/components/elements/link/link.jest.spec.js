...
describe('VsLink', () => {
	...
	it('should render a b-link with class vs-link', () => {
		...
		expect(wrapper.is("b-link-stub")).toBe(true)
	})
	...
	describe(':props', () => {
		...
		it(':variant - should render the dark variant', () => {
			const wrapper = factoryShallowMount({ variant: 'dark' })
		...
		it(':external - should render an external link', () => {
			const wrapper = factoryShallowMount({ external: true })
