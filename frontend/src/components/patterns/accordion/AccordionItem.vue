<template>
    ...
    >
        <BCardHeader
            role="tab"
            class="vs-accordion__item-card-header"
        >
            ...
            <h4
                class="d-none vs-accordion__item-title"
        ...
        <BCardBody
            v-show="show"
            :id="controlId"
            class="vs-accordion__item-panel"
            :class="toggleResponsiveItem"
        >
...
.vs-accordion__item.card {
    ...
    .vs-accordion__item-card-header {
        padding: 0;
        border: 0;
        background-color: transparent;
    }

    .btn.vs-accordion__item-toggle-btn {
        text-align: left;

    }

    .vs-accordion__item-title {
        margin: $spacer-3;
        line-height: 1;
        font-weight: 500;
    }

    .vs-accordion__item-panel.card-body {
...
@include no-js {
    ...
    .vs-accordion__item .vs-accordion__item-panel {
