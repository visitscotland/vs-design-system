...
const factoryShallowMount = propsData => {
    return shallowMount(VsSummaryBoxDistanceLabel, {
        propsData: {
            ...propsData,
        },
    })
...
const factoryMount = propsData => {
    return mount(VsSummaryBoxDistanceLabel, {
        propsData: {
            ...propsData,
        },
        methods: {
...
describe("VsSummaryBoxDistanceLabel", () => {
    ...
    it("should accept an distanceLabel property", () => {
        const wrapper = factoryShallowMount({ distanceLabel: "Entfernung" })
        expect(wrapper.html()).toContain('<strong class="d-block">Entfernung</strong>')
    })

    it("should accept an milesLabel property", () => {
        const wrapper = factoryShallowMount({ milesLabel: "meilen" })
        expect(wrapper.html()).toContain(
    ...
    it("should accept an milesAbbr property", () => {
        const wrapper = factoryShallowMount({ milesAbbr: "test-abbreviation" })
        expect(wrapper.html()).toContain('<abbr title="miles">test-abbreviation</abbr>')
    })

    it("should accept an kilometresLabel property", () => {
        const wrapper = factoryShallowMount({ kilometresLabel: "kilomètres" })
        expect(wrapper.html()).toContain(
    ...
    it("should accept an kilometresAbbr property", () => {
        const wrapper = factoryShallowMount({ kilometresAbbr: "booya!" })
