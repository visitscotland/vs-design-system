...
describe('VsMegaNavTopMenuItem', () => {
    it('should render a component with the class `.vs-mega-nav__top-menu__item`', () => {
        ...
        expect(wrapper.classes()).toContain('vs-mega-nav__top-menu__item');
    });

    describe(':props', () => {
        it('should not render CTA link by default when no props have been provided', () => {
            const wrapper = factoryMount();
            expect(wrapper.find('.vs-mega-nav__cta-link').exists()).toBeFalsy();
        });
        ...
        it('should render CTA link if both `ctaText` and `href` props have been provided', () => {
            ...
            expect(wrapper.find('.vs-mega-nav__cta-link').exists()).toBeTruthy();
        });
    });
    ...
    describe(':slots', () => {
        it('renders content inserted in a buttonContent slot', () => {
            const wrapper = factoryMount();
            expect(wrapper.find('.dropdown-toggle').text()).toBe('Dropdown Toggle');
        });
