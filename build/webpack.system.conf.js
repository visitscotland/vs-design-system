...
const webpackConfig = merge(
  baseWebpackConfig,
  {
    ...
    plugins: [
      ...
      new MiniCssExtractPlugin({
        filename: utils.assetsSystemPath(
          splitComponents ? "components/[name]/component.css" : "[name].css"
        ),
      }),
  ...
  // merge in split components config
  splitComponents ? require("./webpack.system-split-components.conf") : {}
)
