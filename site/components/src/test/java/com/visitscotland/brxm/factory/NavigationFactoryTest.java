...
class NavigationFactoryTest {
    ...
    public NavigationMockBuilder newMockBuilder(){
        return new NavigationMockBuilder(request, utils, bundle, lang);
    }
    ...
    void titleFromResourceBundle_butNotCta() {
        ...
        RootMenuItem menu = factory.buildMenu(request, request.getModel("menu"), Language.ENGLISH);
    ...
    void resourceBundleTakesPrecedenceFromDocumentTitle() {
        ...
        RootMenuItem menu = factory.buildMenu(request, request.getModel("menu"), lang);
