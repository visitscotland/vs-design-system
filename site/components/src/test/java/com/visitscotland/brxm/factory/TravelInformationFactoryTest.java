...
class TravelInformationFactoryTest {
    ...
    void travelInformationModuleCreated() {
        ...
        valueMap.put("train", "Train");
        valueMap.put("cycling", "Cycling");
        when(hippoUtilsService.getValueMap(TRAVEL_INFO_TRANSPORTS_OPTIONS)).thenReturn(valueMap);
        ...
        TravelInformationModule module = factory.getTravelInformation(travelInformation);
