...
class PropertiesTest {
    ...
    void readString(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, "string", Locale.UK)).thenReturn("http://localhost:8181");
    ...
    void readString_env(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, "string", Locale.UK)).thenReturn("$TEST_VS");
    ...
    void readString_env(String value){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, "string", Locale.UK)).thenReturn(value);
        value = "";
    ...
    void readInteger(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_DATA_TRIES, Locale.UK)).thenReturn("3718");
    ...
    void readInteger_env(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_DATA_TRIES, Locale.UK)).thenReturn("$TEST_VS");
        value = "3718";
        assertEquals(3718, properties.getDmsTries());
    }
    ...
    void readInteger_empty(String value){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_DATA_TRIES, Locale.UK)).thenReturn(value);
        value = "";
    ...
    @DisplayName("Reads an integer number from a property")
    void readDouble(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_MAP_DEFAULT_DISTANCE, Locale.UK)).thenReturn("3.14");
    ...
    @DisplayName("Can parse Integers from environment variables")
    void readDouble_env(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_MAP_DEFAULT_DISTANCE, Locale.UK)).thenReturn("$TEST_VS");
        value = "3.14";
        assertEquals(3.14, properties.getDmsMapDefaultDistance());
    }
    ...
    void readDouble_empty(String value){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_MAP_DEFAULT_DISTANCE, Locale.UK)).thenReturn(value);
    ...
    void readBoolean(String value){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, "boolean", Locale.UK)).thenReturn(value);
    ...
    void getDmsEncoding(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_DATA_ENCODING, Locale.UK)).thenReturn("ISO-8859-1");
    ...
    void getDmsEncoding_empty(String value){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_DATA_ENCODING, Locale.UK)).thenReturn(value);
    ...
    void getDmsHost(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_HOST, Locale.UK)).thenReturn("http://test-dms.visitscotland.com");
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.USE_RELATIVE_URLS, Locale.UK)).thenReturn("false");
        assertEquals("http://test-dms.visitscotland.com", properties.getDmsHost());

        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.USE_RELATIVE_URLS, Locale.UK)).thenReturn("true");
    ...
    void getLocalHost(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.CMS_BASE_PATH, Locale.UK)).thenReturn("http:/localhost:8080/site");
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.USE_RELATIVE_URLS, Locale.UK)).thenReturn("true");
        assertEquals("", properties.getDmsHost());
    ...
    void getInstagramURL(){
        ...
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.INSTAGRAM_APP_ID, Locale.UK)).thenReturn("{app-id}");
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.INSTAGRAM_ACCESS_TOKEN, Locale.UK)).thenReturn("{client-token}");
        assertEquals("{app-id}|{client-token}", properties.getInstagramToken());

        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.INSTAGRAM_ACCESS_TOKEN, Locale.UK)).thenReturn("");
    ...
    void getInternalSites(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.INTERNAL_SITES, Locale.UK)).thenReturn("  aaa , bbb,,,ccc,");
    ...
    void propertyValues_defaultConfig(){
        when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_DATA_API_KEY, Locale.UK)).thenReturn("PROP-VALUE");
    ...
    void propertyValues_overrideConfig(){
        ...
        when(utils.getResolvedMount(null)).thenReturn(mount);
        when(mount.getProperty("visitscotland:cmsProperties")).thenReturn(ENV_PROPERTIES);
        when(bundle.getResourceBundle(ENV_PROPERTIES, Properties.DMS_DATA_API_KEY, Locale.UK)).thenReturn("OVERRIDE-VALUE");

        //This is not expected to be called but if were, It shouldn't affect the outcome of the method
        lenient().when(bundle.getResourceBundle(Properties.DEFAULT_CONFIG, Properties.DMS_DATA_API_KEY, Locale.UK)).thenReturn("DEFAULT-VALUE");
    ...
    void propertyValues_overrideConfig_defaultValue(){
        ...
        when(utils.getResolvedMount(null)).thenReturn(mount);
        when(mount.getProperty("visitscotland:cmsProperties")).thenReturn(ENV_PROPERTIES);
        when(bundle.getResourceBundle(ENV_PROPERTIES, Properties.DMS_DATA_API_KEY, Locale.UK)).thenReturn(null);
